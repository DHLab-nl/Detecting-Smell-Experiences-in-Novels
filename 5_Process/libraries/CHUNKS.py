...
"<pronoun>": "{_and|,|or_* det__* poss__* __PART* <adj>* compound__* _-_* __PRON}+",
    ...
    "<smelled_verb>": "_smelled|smelt|scented|stank|sniffed|ponged|perfumed|reeked_VERB",
    "<smelling_verb>": "_smelling|stinking|sniffing|ponging|reeking|reeking_VERB", 
    "<smelly_adj>": "_aromatic|fetid|foetid|odorous|fragrant|fragranced|frowsty|fusty|malodorous|musky|musty|perfumed|piny|piney|pungent|putrid|redolent|ripe|scented|smelly|stinky|whiffy_ADJ",
    #
}
