...
extraction_patterns = [
    ...
    "<noun> _,_* [<adj>*] <smelly_adj> _with_ <pronoun>* [<noun> {_of_ <noun>}*]",  # 1 
    #
    ...
    "[<adj>* <noun>] _lent_ __DET* [<adj>*] <smell_noun>",  # 1
    #
    ...
    "_was_ <smell_verb> _by_ <pronoun>* [<noun> {_of_ <noun>}*]",  # 1
    #
    ...
    "<smelled_verb> _such_* [<noun> {_of_ <noun>}*]",  # 1
    #
